...
def test_add_new_pet_with_valid_data(name='Sobaka', animal_type='haski',
                                     age='3', pet_photo='images/haski.jpg'):
...
def test_add_new_pet_valid_data_but_without_photo(name='Бозфотная', animal_type='Собака', age='3'):
    """Проверяем возможность питомца с валидными данными, но без фото"""
...
def test_add_photo_of_a_pet(pet_photo='images/haski.jpg'):
...
def test_add_new_pet_with_invalid_data(
        name='ееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееее еееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееееее',
        animal_type='Пеееееес', age='3', pet_photo='images/haski.jpg'):
...
def test_add_new_pet_with_invalid_age(name='Собак', animal_type='Собакен',
                                      age='йцуке', pet_photo='images/haski.jpg'):
...
def test_impossible_to_add_new_pet_with_negative_age_number(name='БенджаминБаттон', animal_type='Собак',
                                                            age='-3', pet_photo='images/haski.jpg'):
...
def test_add_new_pet_with_missing_name(name='', animal_type='Жук',
                                       age='30', pet_photo='images/korova.jpg'):
...
def test_add_new_pet_with_valid_data(name='Шарик', animal_type='пес',
                                     age='2', pet_photo='images/haski.png'):
